        ...
        if (_premiumOres.Length != 0)
        {
            ...
            switch (randomNumber)
            {
                case 1:
                    ...
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[0].oreName, _premiumOres[0].oreDescription, _premiumOres[0].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
                case 2:
                    Debug.Log("You got a " + _premiumOres[1].oreName);
                    _ore.ModifyOreAmount(_premiumOres[1], 1);
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[1].oreName, _premiumOres[1].oreDescription, _premiumOres[1].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
                case 3:
                    Debug.Log("You got a " + _premiumOres[2].oreName);
                    _ore.ModifyOreAmount(_premiumOres[2], 1);
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[2].oreName, _premiumOres[2].oreDescription, _premiumOres[2].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
                case 4:
                    Debug.Log("You got a " + _premiumOres[3].oreName);
                    _ore.ModifyOreAmount(_premiumOres[3], 1);
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[3].oreName, _premiumOres[3].oreDescription, _premiumOres[3].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
                case 5:
                    Debug.Log("You got a " + _premiumOres[4].oreName);
                    _ore.ModifyOreAmount(_premiumOres[4], 1);
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[4].oreName, _premiumOres[4].oreDescription, _premiumOres[4].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
                case 6:
                    Debug.Log("You got a " + _premiumOres[5].oreName);
                    _ore.ModifyOreAmount(_premiumOres[5], 1);
                    _uiManager.AssignOverlayValue("You got new ore: " + _premiumOres[5].oreName, _premiumOres[5].oreDescription, _premiumOres[5].oreSprite);
                    _uiManager.OpenOverlay();
                    break;
            }
        }
